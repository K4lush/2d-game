...
class Rope:
    ...
    def update(self):
        ...
        # 2. Check if both players are not on the ground
        if not (self.player1.is_on_ground or self.player2.is_on_ground):
            # If both players are airborne, do not apply pull
            return

        # 3. Check if rope needs to pull a player
